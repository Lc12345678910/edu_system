...
.login-container {
  ...
  align-items: center; // 使表单垂直水平居中

 .login-form {
    position: relative;
    width: 520px;
    max-width: 80%; // 增加响应式，最大宽度为屏幕的80%
    padding: 100px 35px 0;
    background-color: rgba(0, 0, 0, 0.5); // 表单背景色半透明
    border-radius: 10px; // 表单边框圆角
    box-shadow: 0 0 10px rgba(0, 0, 0, 0.3); // 表单阴影
    ...
    input:focus {
      border-color: $primary-color; // 输入框聚焦时边框颜色
    }
  }
 ...
 .title-container {
   ...
   .title {
      font-size: 32px;
      color: $primary-color; // 标题颜色改为主要颜色
      margin: 0px auto;
      text-align: center;
      font-weight: bold;
      text-shadow: 0 0 5px rgba(0, 0, 0, 0.5); // 标题文字阴影
    }
  }
 ...
 .el-button {
    ...
    &:hover {
      background-color: darken($primary-color, 10%); // 按钮悬停时背景颜色变深
    }
  }
}
</style>